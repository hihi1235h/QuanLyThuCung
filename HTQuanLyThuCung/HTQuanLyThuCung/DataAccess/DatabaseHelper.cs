...
namespace HTQuanLyThuCung.DataAccess
{
            ...
            get
            {
                if (string.IsNullOrEmpty(_connectionString))
                {
                    _connectionString = ConfigurationManager
                        .ConnectionStrings["QuanLyThuCungConnection"]?.ConnectionString;

                    if (string.IsNullOrEmpty(_connectionString))
                    {
                        throw new Exception("Không tìm thấy connection string 'QuanLyThuCungConnection' trong App.config");
                    }
                }
